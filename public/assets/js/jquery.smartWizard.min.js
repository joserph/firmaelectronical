...
!function (e) {
  ...
  var i = {
    ...
    return _createClass(n, [{
      ...
      key: "_keyNav",
      value: function value(t) {
        if (this.options.keyboard.keyNavigation) if (-1 < l.inArray(t.which, this.options.keyboard.keyLeft)) this._navigate("prev"), t.preventDefault();else {
  ...
  l.fn.smartWizard = function (t) {
    ...
    slideSwing: function slideSwing(t, s, e, n, i) {
    ...
    slideHorizontal: function slideHorizontal(t, s, e, i, n) {
      var o, a, r, h;
      l.isFunction(t.animate) ? (o = function o(t, s, e, n) {
        t.css({
          position: "absolute",
          left: s
        }).show().animate({
    ...
    slideVertical: function slideVertical(t, s, e, i, n) {
      var o, a, r, h;
      l.isFunction(t.animate) ? (o = function o(t, s, e, n) {
        t.css({
          position: "absolute",
    ...
    css: function css(t, s, e, n, i) {
      var o, a, r;
      0 != n.options.transition.fwdHideCss.length && 0 != n.options.transition.bckHideCss.length ? (o = function o(t, s, e) {
