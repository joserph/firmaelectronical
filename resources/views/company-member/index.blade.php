...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Lista de Registros Miembro de Empresa</li>
        </ol>
    </nav>
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Lista de Registros Miembro de Empresa
        <a href="{{ route('company-member.create') }}" class="btn btn-info fa-pull-right"><i class="fas fa-plus-circle"></i> Agregar</a>
    </h1>
        ...
        <table class="table table-hover table-bordered table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><small><a href="{{ route('company-member.show', $item->id) }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a></small></td>
                    <td class="text-center"><small><a href="{{ route('company-member.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a></small></td>
                    <td class="text-center"><small><a href="{{ route('company-member.show', $item->id) }}" class="btn btn-success btn-sm"><i class="fas fa-file-upload"></i></a></small></td>
                    <td class="text-center"><small><a href="{{ route('company-member.show', $item->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-search"></i></a></small></td>
                    <td class="text-center"><small>
                        {!! Form::open(['method' => 'DELETE', 'route' => ['company-member.destroy', $item->id], 'style' => 'display:inline']) !!}
