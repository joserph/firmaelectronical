<div class="form-row">
    ...
    <div class="col-md-3">
        <div class="form-group " id="g_nombresRL">
            {{ Form::label('nombresRL', 'Nombre RL') }} <i class="fab fa-diaspora text-warning"></i>
            {{ Form::text('nombresRL', null, ['class' => 'form-control form-control-sm', 'required', 'id' => 'i_nombresRL', 'placeholder' => 'Fernando']) }}
            @error('nombresRL')
                {{ $message }}
            @enderror
            <div class="invalid-feedback2" id="error_nombresRL">
                
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group " id="g_apellidosRL">
            {{ Form::label('apellidosRL', 'Apellidos RL') }} <i class="fab fa-diaspora text-warning"></i>
            {{ Form::text('apellidosRL', null, ['class' => 'form-control form-control-sm', 'required', 'id' => 'i_apellidosRL', 'placeholder' => 'Saenz Miño']) }}
            @error('apellidosRL')
                {{ $message }}
            @enderror
            <div class="invalid-feedback2" id="error_apellidosRL">
                
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group" id="g_tipodocumentoRL">
            {{ Form::label('tipodocumentoRL', 'Documento de Identidad RL') }} <i class="fab fa-diaspora text-warning"></i>
            {{ Form::select('tipodocumentoRL', [
                'CEDULA' => 'CEDULA', 
                'PASAPORTE' => 'PASAPORTE'],
                null, ['class' => 'custom-select custom-select-sm', 'required', 'id' => 'i_tipodocumentoRL', 'placeholder' => 'Seleccione Tipo Documento']) }}
            @error('tipodocumentoRL')
                {{ $message }}
            @enderror
            <div class="invalid-feedback2" id="error_tipodocumentoRL">
                Debe seleccionar un Documento de Identidad
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group" id="g_numerodocumentoRL">
            {{ Form::label('numerodocumentoRL', 'Número de documento RL') }} <i class="fab fa-diaspora text-warning"></i>
            {{ Form::text('numerodocumentoRL', null, ['class' => 'form-control form-control-sm', 'maxlength' => '13', 'onblur' => 'validarDocumento("numerodocumentoRL")', 'required', 'id' => 'i_numerodocumentoRL', 'placeholder' => '0102698867']) }}
            @error('numerodocumentoRL')
                {{ $message }}
            @enderror
            <div class="invalid-feedback2" id="error_numerodocumentoRL">
                El campo es obligatorio
            </div>
        </div>
    </div>
