...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            @endauth
            <li class="breadcrumb-item active" aria-current="page">Editar Firma Miembro de Empresa</li>
        </ol>
    </nav>
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Editar Miembro de Empresa</h1>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-12">
            ...
            <div class="wizard">
                ...
                {{ Form::model($company_member, ['route' => ['company-member.update', $company_member->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
