...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Editar Firma Representante Legal</li>
        </ol>
    </nav>
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Editar Representante Legal</h1>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-12">
            ...
            <div class="wizard">
                ...
                {{ Form::model($legal_representative, ['route' => ['legal-representative.update', $legal_representative->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                    <div class="row setup-content" id="step-1">
                        <div class="col-xs-6 col-md-offset-3">
                            <div class="col-md-12">
                                @include('legal-representative.partials.formInput')
                    ...
                    <div class="row setup-content" id="step-2">
                        <div class="col-xs-6 col-md-offset-3">
                            <div class="col-md-12">
                                @include('legal-representative.partials.formField')
                                <ul class="list-inline pull-right">
