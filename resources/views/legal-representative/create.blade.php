...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Representante Legal</h1>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-12">
            ...
            <div class="wizard">
                ...
                {{ Form::open(['route' => 'legal-representative.store', 'method' => 'POST', 'id' => 'natural__person__form', 'enctype' => 'multipart/form-data']) }}
